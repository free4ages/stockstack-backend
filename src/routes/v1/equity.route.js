...
const equityValidation = require('../../validations/equity.validation');
 ...
 * equities:
 *   name: Equities
 *   description: Equity management and retrieval
 */
 ...
 * /equities:
 *   post:
 *     summary: Create a equity
 *     description: Only admins can create other equities.
 *     equities: [Equities]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only admins can retrieve all equities.
 *     equities: [Equities]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of equities
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 * /equities/{id}:
 *   get:
 *     summary: Get a equity
 *     description: Logged in equities can fetch only their own equity information. Only admins can fetch other equities.
 *     equities: [Equities]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in equities can only update their own information. Only admins can update other equities.
 *     equities: [Equities]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in equities can delete only themselves. Only admins can delete other equities.
 *     equities: [Equities]
 *     security:
 *       - bearerAuth: []
 *     parameters:
